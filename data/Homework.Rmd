...
-->
I am going to change subject to a factor. Additionally I am going to change the chronological order of the post and pre test scores
```{r}
str(politics)
...
optimism scores. -->
Here I am going to find the mimimum, mean, and variance for posttest optimism scores. First, I have to assign the optimism scores from the pretest to a variable called optimism score because the optimism scores are listed twice.
```{r}
optimismscore<-politics$optimismscore[trues]
summary(optimismscore)
```
